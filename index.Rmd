...
To explore the characteristics of these curated COVID-19 data sources, visit the [Data Sources tab]( https://mathematica-mpr.github.io/covidinfo/data_sources.html). For more detailed descriptions on all of the resources, please visit the webpage [COVID-19 Curated Data, Modeling, and Policy Resources](https://www.mathematica.org/features/covid-19-curated-data-modeling-and-policy-resources) on Mathematica's webpage. 

******

The diagram below visualizes the flow of data sources (on the left) to resources that compile multiple data sources (in the middle) to "final" resources (on the right). It can be used to understand what primary data sources are underlying key COVID-19 resources. 
...
```{r, fig.width = 12, fig.height=1, dpi = 600}
legend <- c("Raw data" = "#F1B51C", 
            "Data compilation" = "#189394", 
            "'Final' resource" = "#17A673")
